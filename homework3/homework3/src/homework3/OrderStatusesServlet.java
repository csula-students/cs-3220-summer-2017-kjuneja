...
public class OrderStatusesServlet extends HttpServlet {
	public void init() {
		...
		orders.add(new Order(null, orders.size(), "Hamburger", "Kunal",new Date(), null));
		orders.add(new Order(null, orders.size(), "Chilli Cheese Fries", "Michael",new Date(), null));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Order entry: orders) {
			out.println(
						"<tr>" + "<td>"+entry.getCreated() + "</td>" +"<td>" + entry.getItems() + "</td>" + "<td>" +entry.getCustname() + "</td>" + "<td>" +entry.getStatus()+"</td>"+
